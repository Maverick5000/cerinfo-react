  ...
  render() {
    return (
      <Switch>
        ...
        <Route component={ProductList} exact path='/libros' />
        ...
        <Route component={Multas} exact path='/Multas' />
        <Route component={Prestamos} exact path='/Prestamos' />
        <Route component={Solicitudes} exact path='/Solicitudes' />
      </Switch>
    );
  }
}
